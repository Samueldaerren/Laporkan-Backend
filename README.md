...
2. buat .env di root folder isinya (PORT=3000, DB_HOST=localhost, DB_PORT=5432, DB_NAME=laporkan_db, DB_USER=postgres, DB_PASSWORD=postgres, JWT_SECRET=secretkey, JWT_EXPIRES_IN=7d)
